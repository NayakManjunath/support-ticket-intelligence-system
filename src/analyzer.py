...
# You MUST select exactly ONE of the following categories:
...
# Password Reset:
# Problems specifically related to resetting or changing passwords.

# Payment Issue:
# Failed payments, duplicate charges, declined cards,
# payment processing problems, or payment transactions.

# Refund:
# Refund requests, missing refunds, delayed refunds,
# or refund status problems.

# Delivery:
# Late delivery, missing delivery, shipping delays,
# or delivery tracking problems.

# Account Access:
# Problems logging into or accessing an account,
# including account lockouts and access failures.

# Technical Issue:
# Application crashes, bugs, errors, broken features,
# or technical malfunctions.

# Order Issue:
# Problems with orders, order status, incorrect orders,
# cancelled orders, or order-related problems.

# Billing:
# Invoices, billing amounts, unexpected charges,
# billing statements, or billing-related questions.

# Subscription:
# Subscription activation, cancellation, renewal,
# plan changes, or subscription-related problems.
...
# Other:
# Use only when the issue does not reasonably fit
...
# Low:
# Minor issue with limited impact and no urgency.

# Medium:
# Normal customer issue that requires support attention
# but does not have significant urgency.

# High:
# Significant customer impact, inability to access an important
# service, financial problems, repeated failures, or explicit urgency.

# Critical:
# Severe security concerns, suspected account compromise,
# major financial impact, or issues requiring immediate attention.

# ============================================================
# SENTIMENT
# ============================================================

# Determine the customer's expressed emotional tone.
...
# Do not infer extreme emotions without evidence.

# ============================================================
# OUTPUT RULES
# ============================================================

# 1. Analyze only the information contained in the ticket.
# 2. Do not invent facts.
# 3. Select exactly one category from the allowed taxonomy.
# 4. Keep the issue concise.
# 5. Keep the summary business-friendly.
# 6. Recommend a practical support action.
# 7. Return structured information only.
# """
...
# SYSTEM_INSTRUCTION = """
#  You are an expert customer support ticket analyst.
#  Analyze the customer's suport ticket and convert the unstructured text into structured business information.
 
#  Rules:
#  1. Identify the promary category of the issue
#  2.Deermine the priority based on urgency, business impact, financial impact, account access, security concerns and explicit urgency from the customer.
#  3.Determine the customers sentiment.
#  4.Describe the actual issue concisely
#  5.Create a short business-friendly summary
#  6.Record a practical action for the support team
#  7.Do not invent facts that are not present in the ticklet
#  8. focus on the customers actual problem
#  9.Return only the required structured fields.
#  """

# def analyze_ticket(ticket_text: str) -> TicketAnalysis:
#     prompt=f"""
# {SYSTEM_INSTRUCTION}
# Customer Support Ticket: {ticket_text}
# """
# response = client_models.generate_content(
#     model = MoDEL_NAME,
#     content = prompt,
#     config= {

#         "response_mime_type": "application/json",
#         "response_json_schema": TicketAnalysis.model_jon_schema(),
#     }
# )
