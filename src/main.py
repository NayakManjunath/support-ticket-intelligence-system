...
# from src.config import (INPUT_FILE, MAX_TICKETS,OUTPUT_FILE)
# from src.logger import get_logger
...
#     print("=" * 70)
#     print("SUPPORT TICKET INTILIGENCE SYSTEM")

#     print("=" * 70)
#     print(f"\n Reading Dataset :{INPUT_FILE} \n")

#     df = pd.read_csv(INPUT_FILE)
#     print(f"Total Tickets in Dataset: {len(df)}\n")
...
#     # Free API Limitations: Process only the first MAX_TICKETS tickets
#     df = df.head(MAX_TICKETS).copy()

#     print(f" Ticket selected for Gemini analysis: {len(df)}\n")
...
#             logger.info(
#                 "Ticket completed successfully | ticket_id=%s",
#                 ticket_id,
#             )
...
#             print(
#                 "\nThe pipeline completed, but Gemini did not "
#                 "successfully analyze any tickets."
#             )
